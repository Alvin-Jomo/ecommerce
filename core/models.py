...
class Product(models.Model):
    ...
    user = models.ForeignKey(User, on_delete=models.SET_NULL, null=True, default="ALVIN")
    ...
    price = models.DecimalField(
        max_digits=12, decimal_places=2, default="5.00")
    old_price = models.DecimalField(
        max_digits=12, decimal_places=2, default="20.99")
    ...
    stock_count = models.CharField(
        max_length=100, default="1000", null=True, blank=True)
    life = models.CharField(
        max_length=100, default="1000 Days", null=True, blank=True)
...
class CartOrder(models.Model):
    ...
    manager = models.CharField(max_length=100, null=True, blank=True)  # Add this line
    location = models.CharField(max_length=100, null=True, blank=True) # Add this line
...
# New field to track when the last reminder was sent
    last_reminder_sent = models.DateTimeField(null=True, blank=True)
    amount_already_paid = models.DecimalField(max_digits=10, decimal_places=2, default=0.00) #new field
...
class CartOrderProducts(models.Model):
    ...
    size = models.CharField(max_length=20, choices=SIZE_CHOICES, default="Medium")  # New field
...
class Expenditure(models.Model):
    ...
    date = models.DateField(auto_now_add=True)  # Default to current date

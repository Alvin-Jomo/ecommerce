...
JAZZMIN_SETTINGS = {
    'site_header': "Evelyfresh-ventures",
    'site_brand': "You order, we deliver",
    'site_logo': "assets/imgs/theme/loading.gif",
    'copyright': "Evelyfresh-ventures",
}
...
EMAIL_HOST_PASSWORD = 'wckhzviqcabszodr'
...
TWILIO_WHATSAPP_NUMBER = 'whatsapp:+12096466110'

PESAPAL_CONSUMER_KEY = os.getenv(' pYFKAjL8CAofSBNqJ1AuMaPTawWNzRBAY')
PESAPAL_CONSUMER_SECRET = os.getenv('+0ZLeUN7nqEC2PiEs0BT+UKiZ5c=')
PESAPAL_LIVE_URL = 'https://pay.pesapal.com/v3'


PAYPAL_RECEIVER_EMAIL = 'alvotheboss@gmail.com'
PAYPAL_TEST = True


STRIPE_PUBLIC_KEY = os.getenv('STRIPE_PUBLIC_KEY', 'your-stripe-public-key-here')
